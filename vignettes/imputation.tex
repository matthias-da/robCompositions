...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: robustbase\\\#\# Loading required package: ggplot2\\\#\# Loading required package: data.table\\\#\# data.table 1.9.4\ \ For help type: ?data.table\\\#\# *** NB: by=.EACHI is now explicit. See README to restore previous behaviour.\\\#\# sROC 0.1-2 loaded}}\end{kframe}
\end{knitrout}
%<<data sets>>=
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{library}\hlstd{(robCompositions)}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in quantile.default(d, k/length(d)): missing values and NaN's not allowed if 'na.rm' is FALSE}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in quantile.default(d, k/length(d)): missing values and NaN's not allowed if 'na.rm' is FALSE}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in paste("{}DV: iterative lm approach:"{}, round(variations1, 3)): object 'variations1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in paste("{}DV: iterative ltsReg approach:"{}, round(variations2, 3)): object 'variations2' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lm.fit(x, y, offset = offset, singular.ok = singular.ok, ...): 0 (non-NA) cases}}\end{kframe}
\end{knitrout}
