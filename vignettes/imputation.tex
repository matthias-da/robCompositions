...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: robustbase\\\#\# Loading required package: ggplot2\\\#\# Loading required package: data.table\\\#\# Loading required package: pls\\\#\# \\\#\# Attaching package: 'pls'\\\#\# \\\#\# The following object is masked from 'package:stats':\\\#\# \\\#\#\ \ \ \  loadings}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::cov.mve' when loading 'robCompositions'}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::ginv' when loading 'robCompositions'}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::mvrnorm' when loading 'robCompositions'}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::parcoord' when loading 'robCompositions'}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::rlm' when loading 'robCompositions'}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'MASS::stepAIC' when loading 'robCompositions'}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# sROC 0.1-2 loaded}}\end{kframe}
\end{knitrout}
%<<data sets>>=
